...
ACLOCAL = ${SHELL} /root/fuse-2.9.0/missing --run aclocal-1.11
AMTAR = ${SHELL} /root/fuse-2.9.0/missing --run tar
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /root/fuse-2.9.0/missing --run autoconf
AUTOHEADER = ${SHELL} /root/fuse-2.9.0/missing --run autoheader
AUTOMAKE = ${SHELL} /root/fuse-2.9.0/missing --run automake-1.11
AWK = mawk
CC = gcc
...
LTLIBICONV = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /root/fuse-2.9.0/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
...
VERSION = 2.9.0
abs_builddir = /root/fuse-2.9.0
abs_srcdir = /root/fuse-2.9.0
abs_top_builddir = /root/fuse-2.9.0
abs_top_srcdir = /root/fuse-2.9.0
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /root/fuse-2.9.0/install-sh
...
SUBDIRS = include lib util example doc
EXTRA_DIST = \
	fuse.pc.in		\
	README*			\
	Filesystems		\
